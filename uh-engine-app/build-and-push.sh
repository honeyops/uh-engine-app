#!/bin/bash
DB_NAME="uh_engine_app_database"
SCHEMA_NAME="public"
IMAGE_REPO_NAME="images"
SERVICE_NAME="uh_engine_app_service" # service_spec.yml and manifest.yml needs to agree with this name as it is the service and image name.
DIR_NAME="./service"
